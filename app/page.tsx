...
// ---------------------------------------------------------------------------
// Pricing (client component with annual billing toggle)
// ---------------------------------------------------------------------------
    ...
    <footer className="border-t border-[#D1D5C8] bg-white px-4 py-14 sm:px-6 lg:px-8">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-6 sm:flex-row sm:justify-between">
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 text-sm">
          ...
          <Link href="/guides/breeder-guide" className="text-stone-500 transition hover:text-amber-700">
            Breeder Guide
          </Link>
...
export default function Home() {
  return (
    <div className="min-h-screen bg-white" style={{ scrollBehavior: "smooth" }}>
      ...
      <WaveDivider flip fillColor="#FFFBEB" />
      <PricingSection
        basicMonthlyUrl={STRIPE_PAYMENT_LINKS.basic}
        basicAnnualUrl={STRIPE_PAYMENT_LINKS.basic_annual}
        proMonthlyUrl={STRIPE_PAYMENT_LINKS.pro}
        proAnnualUrl={STRIPE_PAYMENT_LINKS.pro_annual}
      />
      <WaveDivider fillColor="#FFFBEB" />
      <FAQ />
      <BottomCTA />
